  ...
  //TODO 
   ...
   for (int i = 0; i < words.size(); i++) {
     ...
     if (words.get(i).compareTo(wordToFind) == 0) {
       SearchResult sR = new SearchResult(i, iterations);
       return sR;
     }
   }
   SearchResult sR = new SearchResult(-1, iterations);
   return sR;
 }
  ...
  //TODO 
   ...
   while (min <= max) {
     ...
     if (words.get(mid).compareTo(wordToFind) == 0) {
       SearchResult sR = new SearchResult(mid, iteration);
       return sR;
     }
   ...
   SearchResult sR = new SearchResult(-1, iteration);
   return sR;
 }
